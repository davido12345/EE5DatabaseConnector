...
public class InfoArrays {
    ...
    public static ArrayList<Double> Acc_X_1SD = new ArrayList<Double>();
    public static ArrayList<Double> Acc_Y_1SD = new ArrayList<Double>();
    public static ArrayList<Double> Acc_Z_1SD = new ArrayList<Double>();
    public static ArrayList<Double> Pitch_1SD = new ArrayList<Double>();
